                                ...
                                <div class="tab-pane active" id="profile">
                                    ...
                                    <form>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control autosize" id="bio" placeholder="Write something about you" style={{overflow: "hidden",overflowWrap: "breakWord", resize: "none", height: "62px"}}>A front-end developer that focus more on user interface design, a web interface wizard, a connector of awesomeness.</textarea>
                                        </div>
                                        <div class="form-group">
